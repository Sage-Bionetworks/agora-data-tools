...
class ColumnNestedObjectStrLength(ColumnMapMetricProvider):
    ...
    condition_value_keys = ("mostly_threshold","target_field","operator","length_threshold")
    ...
    def _pandas(cls, column: pd.core.series.Series, **kwargs) -> pd.Series:
        ...
        op_func_map = {">=": operator.ge, ">": operator.gt, "<=": operator.le, "<": operator.lt, "==": operator.eq}
        ...
        if op_func is None:
            raise ValueError(f"{operator} is not a valid operator. The available options are: >=, >, <=, <, ==")
        
        counts = cls._flatten_nested_object_count_invalid_string(list_object=list(column), target_field=target_field, op_func=op_func, length_threshold=length_threshold)
        
        if counts["total_dict"] > 0: 
            invalid_percentage = round(counts["total_invalid"]/counts["total_dict"], 1)
        else: 
    ...
    def _flatten_nested_object_count_invalid_string(list_object: list[list[dict[str, str | int | bool | None]]], target_field: str, op_func: str, length_threshold: int) -> dict[str, int]:
        """
        ...
        def _flatten(list_object): 
            for item in list_object:
                if isinstance(item, list): 
                    ...
                    if not target_field_value or not isinstance(target_field_value, str) or not op_func(len(target_field_value), length_threshold): 
    ...
    examples = [
        {
            "data": {
                ...
                "a": [[{"targeted": "a", "other_key": "not empty"}], [{"targeted": "", "other_key": "not empty"}]],
                # "targeted" is None in one row — 1/2 null
                "b": [[{"targeted": "b", "other_key": "not empty"}], [{"targeted": None, "other_key": ""}]],
                ...
                "d": [[{"targeted": "aaa", "other_key": "not empty"}], [{"targeted": "aaa", "other_key": "not empty"}]],
                # both rows are emtpy
                "e": [[], []],
                # "targeted" has a wrong data type
                "f": [[{"targeted": True, "other_key": "not empty"}], [{"targeted": "aaa", "other_key": "not empty"}]]
            },
            "tests": [
                {
                    ...
                    "in": {"column": "a", "mostly_threshold": 0.4, "target_field": "targeted", "operator": ">", "length_threshold": 0},
                    "out": {"success": True},
                },

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "b", "mostly_threshold": 0.4, "target_field": "targeted", "operator": ">", "length_threshold": 0},
                    "out": {"success": True},
                },

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "c", "mostly_threshold": 0.1, "target_field": "targeted", "operator": ">", "length_threshold": 0},
                    "out": {"success": False},
                },

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "d", "mostly_threshold": 0.9, "target_field": "targeted", "operator": ">=", "length_threshold": 4},
                    "out": {"success": False},
                },

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "d", "mostly_threshold": 0.9, "target_field": "targeted", "operator": "<=", "length_threshold": 3},
                    "out": {"success": True},
                },
...

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "e", "mostly_threshold": 1, "target_field": "targeted", "operator": ">", "length_threshold": 0},
                    "out": {"success": True},
                },

                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "f", "mostly_threshold": 1, "target_field": "targeted", "operator": ">=", "length_threshold": 1},
                    "out": {"success": False},
                },
