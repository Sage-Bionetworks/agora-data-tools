...
1. Test data processing by running `adt configs/agora_preprod.yaml --upload` and ensure that HTML reports with all expectations are generated and uploaded to the proper folder in Synapse.
