...
# eqtl_filters: a csv-compatible dataframe containing a row of values per CT filterset:
#
# eqtl_filter_values: A list of lists of filter values; value lists must be in the same order as the filters
#
...
cell_classes <- download_file("syn77140302", cell_classes, "txt")
cell_subclasses <- download_file("syn77140299", cell_subclasses, "txt")
filter_vals <- list(
  c('rs12345', 'rs67890'),
  c('geneA', 'geneB'),
  cell_classes,
...
download_file("syn77140302", genesis_cell_classes, "txt")
```
