...
# Abetas
threex_abs_sol_source <- download_file('syn25913411', type = "csv")
threex_abs_insol_source <- download_file('syn25913418', type = "csv")
# NO NFL DATA
...
# Abetas
fivex_abs_sol_source <- download_file('syn22101767', type = "csv")
fivex_abs_insol_source <- download_file('syn22101766', type = "csv")
# fivex_abs_plasma_source <- download_file('syn22101772', type = "csv")
# NO NFL DATA
...
# Abetas
nss_abs_sol_4mo_source <- download_file('syn29568621', type = "csv")
nss_abs_sol_12mo_source <- download_file('syn29568624', type = "csv")
nss_abs_insol_4mo_source <- download_file('syn29568619', type = "csv")
nss_abs_insol_12mo_source <- download_file('syn29568622', type = "csv")
# NFL
nss_nfl_cortex_source <- download_file('syn29568489', type = "csv")
nss_nfl_plasma_source <- download_file('syn29568490', type = "csv")
...
# Abetas
abca7_abs_sol_4mo_source <- download_file('syn30859386', type = "csv")
abca7_abs_sol_12mo_source <- download_file('syn30859377', type = "csv")
abca7_abs_insol_4mo_source <- download_file('syn30859383', type = "csv")
abca7_abs_insol_12mo_source <- download_file('syn30859387', type = "csv")
# NFL
abca7_nfl_cortex_source <- download_file('syn30859379', type = "csv")
abca7_nfl_plasma_source <- download_file('syn30859380', type = "csv")
```
