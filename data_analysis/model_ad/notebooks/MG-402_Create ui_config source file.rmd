...
# RNA - Composite id / parent-child fields
# -----------------------------------------
rna_de_row_id_data_key <- "composite_id"
rna_de_parent_id_data_key <- "composite_id"
rna_de_parent_noun <- list(singular = "gene", plural = "genes")
...
# Protein - Composite id / parent-child fields
# ----------------------------------------------
...
protein_de_child_noun <- list(singular = "protein", plural = "proteins")
...
build_de_object <- function(menu1_label, tissue_label, dynamic_names,
                            ...
                            row_id_data_key, parent_id_data_key, parent_noun, child_noun = NULL) {
...
build_rna_de_objects <- function() {
  ...
  lapply(rna_de_menu2, function(tissue) {
    ...
    build_de_object(rna_de_menu1, tissue, dynamic_names, dynamic_model_filter_vals,
                    ...
                    rna_de_row_id_data_key, rna_de_parent_id_data_key, rna_de_parent_noun)
  })
}
...
build_protein_de_objects <- function() {
  ...
  lapply(protein_de_menu2, function(tissue) {
    build_de_object(protein_de_menu1, tissue,
                    ...
                    protein_de_parent_noun, protein_de_child_noun)
  })
}
