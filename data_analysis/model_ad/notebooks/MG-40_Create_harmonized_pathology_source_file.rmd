...
* 5xFAD
* Trem2-R47H_NSS
* Abca7*V1599M -> MG-848: Abca7 pathology results are currently excluded due to source metadata issues; search/address all instance of "MG-848" here to reenable
...
*********
# MG-848 - don't download abca7 source files we aren't using
# Add this code back to the chunk above once MG-848 is resolved.
# ************
# Abca7*V1599M
# ************
#Abca7
...
*************
### Abca7*V1599M
# MG-848 - omit abca7 pathology data from release due to invalid metadata
# This chunk will fail until MG-848 is resolved; don't bother running it.
```{r}
...
*********
# MG-848 - disable validation of removed results
# Add this code back to the chunk above once MG-848 is resolved.
# ************
# Abca7*V1599M
# ************
...
END MG-848 disabled validation
*********
...
pathology_final <- bind_rows(
  ...
  fivex_final,
  nss_final)
  # MG-848 - remove abca7 pathology data from release due to invalid metadata
  #abca7_final)
