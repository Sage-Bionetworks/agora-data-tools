...
join_to_metadata <- function(results, individual_metadata, biospecimen_metadata) {
  ...
  if (nrow(mismatches) > 0) {
    ...
    print("FATAL: Metadata inconsistency found in pooled specimens:")
    print(mismatches)
    stop("Script halted. Pooled specimens must have uniform sex, genotype, and ageDeath.")
  }
  # *** END METADATA INTEGRITY CHECK ***
...
# Skip running this chunk until MG-848 is resolved; it will fail unless the metadata has been corrected.
```{r}
